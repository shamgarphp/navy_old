...
<html lang="en">
  ...
  <body class=" login">
    ...
    <form class="login-form" action=""  method="POST" name="login">
        <h3 class="form-title">Login to your account
        </h3>
        <div class="form-group">
          ...
          <div class="input-icon">
            ...
            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="email" name="admin_email" id="admin_email" /> 
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="input-icon">
            ...
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="pass" id="pass" /> 
          </div>
        </div>
         
        <div class="form-actions">
          <label class="rememberme">
             <a class="copyright" href="<?php echo base_url('forgotpass'); ?>">Forgot Password</a>
            <span></span>
          </label>
          <button type="submit" class="btn green pull-right" name="admin_login" id="admin_login" value="submit"> Login 
          </button>
        </div> 
